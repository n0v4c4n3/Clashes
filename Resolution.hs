...
--      si es UNSAT, retorna un conjunto de clausulas incluyendo la clausula vacia
...
-- Pos: si hay un conflico, retorna un Just con el literal conflictivo
--      si no hay conflicto, retorna Nothing
